...
exports.create = async (req, res, next) => {
    try {
        ...
        const { title, ingredients, image, price } = req.body;
        const created = await Pizza.create({ title, ingredients, image, price });
        // 201 Created
...
exports.update = async (req, res, next) => {
    try {
        ...
        const { title, ingredients, imageUrl, price } = req.body;
        const updated = await Pizza.update(id, { title, ingredients, imageUrl, price });
